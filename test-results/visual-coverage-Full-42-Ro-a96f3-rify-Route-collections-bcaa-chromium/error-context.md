...
- Name: visual-coverage.spec.ts >> Full 42 Route Coverage >> Verify Route: /collections/bcaa
...
Call log:
  - navigating to "http://localhost:3000/collections/bcaa", waiting until "domcontentloaded"
