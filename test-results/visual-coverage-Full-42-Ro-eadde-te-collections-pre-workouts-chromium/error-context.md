...
- Name: visual-coverage.spec.ts >> Full 42 Route Coverage >> Verify Route: /collections/pre-workouts
...
Call log:
  - navigating to "http://localhost:3000/collections/pre-workouts", waiting until "domcontentloaded"
