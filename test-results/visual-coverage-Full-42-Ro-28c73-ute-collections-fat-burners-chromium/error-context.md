...
- Name: visual-coverage.spec.ts >> Full 42 Route Coverage >> Verify Route: /collections/fat-burners
...
Call log:
  - navigating to "http://localhost:3000/collections/fat-burners", waiting until "domcontentloaded"
